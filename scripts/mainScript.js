...
import { previousUnread, nextUnread } from "/scripts/unreadJumps.js"
...
const mainScript = () => {
	...
	const dict = new Map([
		...
		["KeyE", () => previousUnread(currentPos)], //* "previous unread" comment
		["KeyD", () => nextUnread(currentPos)], //* "next unread" comment
		["KeyR", () => parentJump(currentPos)], //* Jump to the parent comment
		["KeyF", () => backToChild(currentPos)], //* Jump back to original child comment from parent
